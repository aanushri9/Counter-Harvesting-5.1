...
"}")
        ...
        self.dateedit1_2.setDisplayFormat("MM-yyyy")
...
"}")
        ...
        self.gridLayout_6.addWidget(self.listView, 1, 0, 1, 2)
...
" ")
        ...
        self.btnFetchSelectedReports = QtWidgets.QPushButton(self.frame_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.gridLayout_8.addWidget(self.btnFetchSelectedReports, 1, 0, 1, 1)
...
"}")
    ...
    def retranslateUi(self, FetchReports):
        ...
        self.dateedit1_3.setDisplayFormat(_translate("FetchReports", "MM-yyyy"))
        ...
        self.All_reports_edit_fetch.setDisplayFormat(_translate("FetchReports", "MM-yyyy"))
