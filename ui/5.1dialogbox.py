...
# Form implementation generated from reading ui file '5.1dialogBox.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_2.addWidget(self.fivezero)
        self.fiveone = QtWidgets.QPushButton(self.frame_4)
        self.fiveone.setStyleSheet("background-color:#e7e7e7;")
        self.fiveone.setObjectName("fiveone")
        self.horizontalLayout_2.addWidget(self.fiveone)
        ...
        self.gridLayout.addWidget(self.edit_vendor_details_frame, 2, 0, 1, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/resources/undo_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/undo_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/remove_vendor_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.edit_vendor_options_frame, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Edit Vendor (5.1)"))
