...
"color:white;}")
        ...
        self.EditVendorText = QtWidgets.QLabel(self.frame_3)
        self.EditVendorText.setEnabled(True)
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(20)
        font.setBold(False)
        font.setWeight(50)
        self.EditVendorText.setFont(font)
        self.EditVendorText.setStyleSheet("")
        self.EditVendorText.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.EditVendorText.setObjectName("EditVendorText")
        self.gridLayout_6.addWidget(self.EditVendorText, 0, 0, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
...
"")
        ...
        self.URLEdit = QtWidgets.QLineEdit(self.edit_vendor_details_frame)
...
"")
        ...
        self.gridLayout_5.addWidget(self.URLEdit, 2, 2, 1, 1)
...
"")
        ...
        self.gridLayout_5.addWidget(self.customerIdEdit, 4, 2, 1, 1)
...
"")
        ...
        self.twoattemptsCheckbox = QtWidgets.QCheckBox(self.edit_vendor_details_frame)
        self.twoattemptsCheckbox.setText("")
        self.twoattemptsCheckbox.setObjectName("twoattemptsCheckbox")
        self.gridLayout_5.addWidget(self.twoattemptsCheckbox, 9, 2, 1, 1)
        self.ipcheckBox = QtWidgets.QCheckBox(self.edit_vendor_details_frame)
        self.ipcheckBox.setText("")
        self.ipcheckBox.setObjectName("ipcheckBox")
        self.gridLayout_5.addWidget(self.ipcheckBox, 10, 2, 1, 1)
        self.requestcheckbox = QtWidgets.QCheckBox(self.edit_vendor_details_frame)
        self.requestcheckbox.setText("")
        self.requestcheckbox.setObjectName("requestcheckbox")
        self.gridLayout_5.addWidget(self.requestcheckbox, 11, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.platformEdit, 6, 2, 1, 1)
...
"}")
    ...
    def retranslateUi(self, editVendors):
        ...
        editVendors.setWindowTitle(_translate("editVendors", "MainWindow"))
        self.EditVendorText.setText(_translate("editVendors", "Edit Vendor "))
        self.label_2.setText(_translate("editVendors", "Base URL"))
        self.label_5.setText(_translate("editVendors", "API Key"))
        self.label_3.setText(_translate("editVendors", "Customer ID"))
        self.All_reports_edit_fetch.setDisplayFormat(_translate("editVendors", "yyyy"))
        self.label_10.setText(_translate("editVendors", "Starting Year"))
        self.label_8.setText(_translate("editVendors", "2 Attempts needed"))
        self.label_28.setText(_translate("editVendors", "Notes"))
        self.companiesText.setText(_translate("editVendors", "Provider"))
        self.label_9.setText(_translate("editVendors", "IP Checking"))
        self.label_11.setText(_translate("editVendors", "Request throttled"))
        self.label_6.setText(_translate("editVendors", "Platform"))
        self.label_4.setText(_translate("editVendors", "Requester ID"))
        self.label.setText(_translate("editVendors", "Name"))
        self.name_validation_label.setText(_translate("editVendors", "*"))
        self.label_12.setText(_translate("editVendors", "*"))
        self.label_13.setText(_translate("editVendors", "*"))
        self.label_14.setText(_translate("editVendors", "*"))
        self.label_15.setText(_translate("editVendors", "*"))
        self.label_16.setText(_translate("editVendors", "*"))
        self.label_17.setText(_translate("editVendors", "*"))
        self.saveVendorChangesButton.setText(_translate("editVendors", "Save Changes"))
        self.undoVendorChangesButton.setText(_translate("editVendors", "Undo Changes"))
        self.removeVendorButton.setText(_translate("editVendors", "Remove Vendor"))
import resources_rc
